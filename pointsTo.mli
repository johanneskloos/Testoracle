...
type points_to_map = Types.jsval Reference.VersionReferenceMap.t
(** Pretty-printer. *)
...
val find_object_facts: Types.objectid -> LocalFacts.local_facts -> points_to_map -> Types.jsval Misc.StringMap.t
